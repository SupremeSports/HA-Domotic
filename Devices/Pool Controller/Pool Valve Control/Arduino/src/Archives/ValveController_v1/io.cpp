...
void ioclass::read_sensors()
{
  ...
  Sw_Mtr[0] = (reading[POT_Solar] < 50) ? false : true;
  Sw_Mtr[1] = (reading[POT_Heater] < 50) ? false : true;
  Sw_Mtr[2] = (reading[POT_Inlet] < 50) ? false : true;
...
int ioclass::calc_inlet()
{
  ...
  else if(Water_Pres < 2)
  {
    ...
    //Add delay to turn off, change percent slowly...
  }
  else if(true)
