...
const char* mqtt_deviceName     = "HouseFDlock-";

//Control
const char* mqtt_controlCmd     = "Home/Door/Front/Cmd";
const char* mqtt_controlStts    = "Home/Door/Front/Stts";
...
//Sensors
const char* mqtt_sensorJson     = "Home/Door/Front/Json";            //MQTT JSON sensor data
...
const char* mqtt_willTopic      = "Home/Door/Front/LWT";
