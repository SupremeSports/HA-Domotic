console.info(
`%c  CUSTOM-UI (JS)  \n%c  Version 20200918b adapted for HA110+  `,
        ...
        window.customUI = window.customUI || {
            ...
            maybeApplyTemplateAttributes(t, e, s, i) {
                ...
                init() {
                    ...
                    t.hass && t.hass.states ? (window.customUI.initDone = !0, window.customUI.runHooks(), window.addEventListener("location-changed", window.setTimeout.bind(null, window.customUI.runHooks, 100)), console.log("Loaded CustomUI JS 20200918b adapted for HA 110.+"), window.addEventListener("hass-more-info", window.customUI.updateMoreInfo), window.CUSTOM_UI_LIST || (window.CUSTOM_UI_LIST = []), window.CUSTOM_UI_LIST.push({
                            name: "CustomUI",
                            version: "JS 20200918b adapted for HA 110.+",
