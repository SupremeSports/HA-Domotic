...
const Version = "20230908-JG";
//const Description = "add templates and icon_color to UI";
const Description = "adapted for HA 2023.9 + ";
...
//JG      if (e instanceof SyntaxError || e instanceof ReferenceError) {
//JG        console.warn(`${e.name}: ${e.message} in template ${functionBody}`);
//JG        return null;
//JG      }
//JG      throw e;
    }
